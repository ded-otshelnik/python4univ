...
3. Представьте результаты тестов в виде файла output.txt (если вы делаете в терминале, то к командам запуска можно добавить в конец `>> output.txt`, который перенаправляет вывод из консоли в файл).
