...
1. Все варианты* должны реализовываться в рамках Чистого кода и должны реализовываться как ООП-архитектуры.
...
3. В качестве итогового результата - набор скриптов (файлов с расширением .py) или простой пакет.

### Варианты

1. **Библиотека**: реализуйте программу **библиотеки**, поддерживающее добавление, удаление и обновление информации о книгах и их авторах. Каждая книга должна иметь название, автора, жанр и год выпуска. Реализуйте возможность поиска книг по различным критериям (название, автор, жанр).
